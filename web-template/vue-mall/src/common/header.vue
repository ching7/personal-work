      ...
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
            <h1>
              <router-link to="/"
                           title="简单商城">简单商城</router-link>
              <span class="title-tip">简单商城</span>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
                              ...
                              <div class="cart-item-inner">
                                ...
                                <div class="item-desc">
                                  <div class="cart-cell">
                                    ...
                                    <h6><span class="price-icon">¥</span><span class="price-num">{{item.productPrice}}</span><span class="item-num">x {{item.productNum}}</span>
                                    </h6>
                                  </div>
                                </div>
...
import { getCartList, cartDel, getCateAll } from '/api/goods'
