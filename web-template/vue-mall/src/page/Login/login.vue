  ...
  <div class="login v2">
    <div>
      <Vcode :show="isShowVcode"
             @success="vcodeSuccess(callbackf)"
      ...
      <div class="dialog dialog-shadow"
        ...
        <div v-if="loginPage"
          ...
          <ul class="common-form">
            ...
            <li style="text-align: right"
                class="pr">
              <span class="pa"
                    style="top: 0;left: 0;color: #d44d44">{{ruleForm.errMsg}}</span>
              <a href="javascript:;"
                 style="padding: 0 5px"
                 @click="loginPage = false">注册 账号 ID</a>
            </li>
          </ul>
          <!--登陆-->
          <div>
            <y-button text="登陆"
                      :classStyle="isLoginOk"
                      @btnClick="beforeLogin"
                      class="btn"></y-button>
          </div>
        </div>
        <div class="registered"
          ...
          <div class="content"
            ...
            <div>
              <y-button :classStyle="isRegOk"
                        text="注册"
                        @btnClick="beforeRegist"
                        class="btn"></y-button>
            </div>
            <ul class="common-form pr">
              <li class="pa"
                  style="left: 0;top: 0;margin: 0;color: #d44d44">{{registered.errMsg}}</li>
...
export default {
  ...
  methods: {
    beforeLogin () {
      ...
      this.callbackf = this.login
    },
    beforeRegist () {
      this.isShowVcode = true
      this.callbackf = this.regist
    },
    // 登陆时将本地的添加到用户购物车
    login_addCart () {
      let cartArr = []
