      ...
      <div slot="content">
        <div v-if="orderList.length">
          <div v-for="(item,i) in orderList"
            ...
            <div class="pr">
              <div class="cart"
                   v-for="(good,j) in JSON.parse(item.goodsList)"
                   :key="j">
                <div class="cart-l"
                     :class="{bt:j>0}">
                  <div class="car-l-l">
                    <div class="img-box"><img :src="good.productImg"
                           alt=""
                  ...
                  <div class="cart-l-r">
                    ...
                    <div class="type"><a @click="_delOrder(item.orderId.toString(),i)"
                         href="javascript:;"
                         v-if="j<1"
